...
if __name__ == "__main__":
    ...
    root_path = "data/second_floor_test_2/pcds" # "data/basement_test/aa_pcds" # "data/basement_test/pcds" # 'test_pcd' #  "data/basement_base_cabinet/pcds" # "data/basement_base_cabinet_extension/aa_pcds" # pcds
